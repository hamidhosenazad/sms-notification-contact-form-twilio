...
<form  method="post">
		<table class="form-table">
			<tbody>
				<tr class="row">
					<th scope="row">
						<label for="twilio-sid"><?php echo esc_html__( 'Twilio Sid', 'sncfwt' ); ?> </label>
					</th>
					<td>
						...
						if ( ! empty( $this->errors['sid'] ) ) {
							echo '<span class="notice notice-error">' . esc_html__( 'Twilio Sid  can not be empty ', 'sncfwt' ) . '</span>';}
						?>
					</td>
				</tr>
				<tr>
					<th scope="row">
					<label for="twilio_auth"><?php echo esc_html__( 'Twilio Auth', 'sncfwt' ); ?> </label>
					</th>
					<td>						
						...
						if ( ! empty( $this->errors['auth'] ) ) {
							echo '<span class="notice notice-error">' . esc_html__( 'Twilio Auth token can not be empty ', 'sncfwt' ) . '</span>';}
						?>
					</td>
				</tr>
				<tr class="row">
					<th scope="row">
					<label for="twilio-sid"><?php echo esc_html__( 'SMS capable Twilio Phone', 'sncfwt' ); ?> </label>
					</th>
					<td>
						...
						if ( ! empty( $this->errors['phone'] ) ) {
							echo '<span class="notice notice-error">' . esc_html__( 'Twilio phone number to send sms can not be empty ', 'sncfwt' ) . '</span>';}
						?>
					</td>
				</tr>
			</tbody>
		...
		<?php submit_button( esc_html__( 'Submit', 'sncfwt' ), 'primary', 'submit_settings' ); ?>
	</form>
